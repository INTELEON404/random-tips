...
EOF
    ...
    echo -e "${CLR_DIM}ID: ${CLR_RST}${CLR_PRP}${CUSTOM_USER}${KALI_SYM}${CLR_CYN}${CUSTOM_HOST}${CLR_RST} ${CLR_DIM}│ $(date +'%H:%M:%S')${CLR_RST}"
    echo
fi

# ===============================
# 4. THE PROMPT (Connected Style)
# ===============================
...
# GF completion 
GF_PATH=$(find $GOPATH/pkg/mod/github.com/tomnomnom/gf* -maxdepth 1 -name "gf-completion.zsh" 2>/dev/null | head -n 1)
